...
class Note {
  ...
  var minFrequency = 250.0;
  var maxFrequency = 270.0;
  var minColor = new Vector4(0.5, 0.0, 0.0, 0.5);
  var maxColor = new Vector4(1.0, 0.0, 0.0, 0.5);
  
  Vector4 color = new Vector4(0.5, 0.0, 0.0, 0.5);
